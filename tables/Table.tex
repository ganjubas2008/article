...
$\lambda=0$ & - \\
& & & & 
$\lambda > 0$ & $\tilde{\O} \left(\frac{1 + \kappa^2 + \rho^2\kappa^4 + \rho ^2\varepsilon^2 \kappa^6 }{T^2} \norm{r_0}^2
         + \frac{\sigma^2}{\lambda^2 MT} 
         + \frac{\rho \kappa^2 \sigma^2}{\lambda^2 M T^2} 
        + \frac{\varepsilon \kappa \sigma^2}{\lambda^2 TR}  \right) $ \\
%_____________________%
